...
const DEMO_ROSTER: Array<{ employeeId: string; subject: string; displayName: string }> = [
  ...
  { employeeId: 'EMP-0004', subject: '+919000000004', displayName: 'Demo Water Dept Officer (Suresh Kumar)' },
  { employeeId: 'EMP-1001', subject: '+919000000004', displayName: 'Suresh Kumar' },
  { employeeId: 'EMP-1002', subject: '+919000000005', displayName: 'Priya Sharma' },
  { employeeId: 'EMP-1003', subject: '+919000000006', displayName: 'Amit Verma' },
